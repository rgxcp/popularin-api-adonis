...
class ReviewLikeController {
  ...
  /**
   * Render a form to be used for creating a new reviewlike.
  ...
  /**
   * Render a form to update an existing reviewlike.
   * GET reviewlikes/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
